...
The equality constraints write: \TODO{sûr??? Il faut pas les intégrer?}
\begin{equation}
...
\end{equation}
The first two terms in \eqref{eq:inequality constraints energy} are convex whereas the last term is concave. \TODO{Thus a problem! Are we going to have minimisers of the Lagrangian? At least a critical point?}
